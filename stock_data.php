...
$stock_10339 = new Stock('10339','36','','XXS','ゼブラウッド（杢目）','ウォーターブルー',6400);
$stock_10292 = new Stock('10292','45','','XXS','ホワイトオーク','ホワイト',6400);
$stock_10357 = new Stock('10357','45','','XXS','桐','ウォーターブルー',6400);
...
$stock_10350 = new Stock('10350','60','','XS','ゼブラウッド（柾目）','ウォーターブルー',7200);
$stock_10351 = new Stock('10351','60','','XS','ゼブラウッド（柾目）','ウォーターブルー',7200);

$stock_10223 = new Stock('10223','30','','L','桐','ウォーターブルー',50000);
$stock_10220 = new Stock('10220','36','','XL','ハードメープル','ウォーターブルー',100000);
