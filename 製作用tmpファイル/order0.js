...
//詳細（合計）の親要素
const total_price_detail_content = document.getElementById('total_price_datail_content');
...
const addForm = () => {
  ...
  //ラジオボタンState追加(追加機能)
  radio_select_states[i] = {'shape':'', 'size':'','color':'','option':'Normal', 'wood':'おまかせ'};
...
let i = 0;//ユニットid
unit_objects[0] = new UnitPrice(i++);